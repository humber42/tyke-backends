package cu.edu.cujae.authservice.security.jwt;

import cu.edu.cujae.authservice.exceptionHandler.UnauthorisedException;
import cu.edu.cujae.authservice.security.CustomUserDetailsService;
import cu.edu.cujae.authservice.constants.ErrorMessage;
import cu.edu.cujae.authservice.constants.SecurityConstants;
...
public class JwtTokenProvider {
    ...
    @PostConstruct
    protected void init() {
        secretKey = Base64.getEncoder().encodeToString(SecurityConstants.SecretKey.getBytes());
    }
